<?php
  ...
  $output = '';
    ...
    if(isset($_POST) && !empty($_POST)) {
        ...
        $Cuatrimestre = $seguridad_usuario->sanitize_str($_POST['Cuatrimestre']);
        ...
        if ($result != false) {
                ...
                <div class="col-sm-12">
                    ...
                    $output .= 
                        '<tr>
                            ...
                            <td class="th-td-nom">
                                <label class="nom" NombreAlumno="'.$row['NOMBREALUMNO'].'">'.$row['NOMBREALUMNO'].'</label>
                            </td>
            ...
            $Valor = $seguridad_usuario->sanitize_str('SE REALIZÓ LA BUSQUEDA DE LAS CALIFICACIONES DE LOS ALUMNOS ACTIVOS EN LA MATERIA: '.
            $Materia.', DEL GRUPO: '.$Grupo.', ASIGNADO AL DOCENTE: '.$Docente.', EN EL CUATRIMESTRE: '.$Cuatrimestre);
