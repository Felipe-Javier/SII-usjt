    ...
    class alumnos extends connection {
        ...
        public function consultar_calificaciones_alumnos ($IdInstructor, $IdGrupo, $IdPlanMateria) {
            try {
                ...
                $resut->bindValue(1, $IdInstructor, PDO::PARAM_INT);
        ...
        public function consultar_CatTipoCorte () {
            try {
                ...
                $result = $this->connection->connect_db()->prepare($query, array(PDO::ATTR_CURSOR => PDO::CURSOR_SCROL));
                $result->execute();
        ...
        public function registrar_calificaciones ($Matricula, $IdRelGrupoAlumno, $Calificacion, $IdTipoCorte, $IdTipoCalificacion, $IdPlanMateria, $IdUsuario) {
            try {
                ...
                $result->bindValue(6, $IdUsuario, PDO::PARAM_INT);
                $result->execute();
